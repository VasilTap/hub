...
# --- Spawner-specific ----
c.JupyterHub.spawner_class = 'mlhubspawner.MLHubSwarmSpawner' # override in your config if you want to have a different spawner. If it is the or inherits from DockerSpawner, the c.DockerSpawner config can have an effect.

c.Spawner.image = "danlenny/ml-workspace-gpu"
c.Spawner.workspace_images = [c.Spawner.image, "danlenny/ml-workspace", "danlenny/ml-workspace-spark"]
...
#c.Spawner.volumes = {
#'/Users/vasiltapkin/Work/_PVH/ml_tools/Leonid/sharedFolder': '/root/workspace/SharedFolder'
# '/tmp': '/workspace/shared'
#}
...
ENV_EXECUTION_MODE = 'swarm'
    ...
    c.Spawner.network_name = 'jupyterhub'
    service_host = "127.0.0.1" #"hub"
